  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md space-y-10">
        ...
        <div className="text-center mb-0 space-y-2">
          <div className="flex items-center justify-center text-blue-700 mb-2">
            <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 8c1.657 0 3 .895 3 2s-1.343 2-3 2v5m0-10c-1.657 0-3 .895-3 2s1.343 2 3 2m-5 8h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
            </svg>
          </div>
        ...
        <form className="space-y-8 bg-white p-8 sm:p-10 rounded-xl shadow-xl-2 border border-gray-100" onSubmit={handleSubmit}>
          ...
          <div className="relative group pb-4">
            ...
            <div className="flex justify-end mt-2">
              <a href="#" className="text-sm font-medium text-blue-600 hover:text-blue-700 transition duration-300">
                Forgot password?
              </a>
            </div>
          </div>
        ...
        <div className="text-center text-sm text-gray-500 pt-4">
           Need help? <a href="#" className="font-semibold text-blue-600 hover:text-blue-700 transition duration-300">Contact Support</a>
        </div>
