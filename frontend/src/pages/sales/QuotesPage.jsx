    ...
    return (
        <div className="p-4 sm:p-8">
            ...
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Quotes</h1>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg-2 border border-gray-100 min-h-[70vh]">
                ...
                <div className="overflow-x-auto whitespace-nowrap border-t border-gray-200">
                    ...
                    <div className="flex items-center border-b border-gray-200 py-3 text-sm font-semibold text-gray-700 min-w-[800px]">
                        ...
                        <span className="w-[15%] px-2 cursor-pointer hover:text-blue-600">DATE</span>
                        <span className="w-[15%] px-2">QUOTE#</span>
                        <span className="w-[15%] px-2">REFERENCE#</span>
                        <span className="w-[25%] px-2">CUSTOMER NAME</span>
                    ...
                    <div className="flex flex-col items-center justify-center h-full pt-20" style={{ minHeight: '40vh' }}>
                        ...
                        <p className="text-xl font-semibold text-gray-700 mb-2">No Quotes Found</p>
                        <p className="text-gray-500 text-center">
                            You haven't created any quotes yet. Click 'New Quote' to create one.
                        </p>
                    </div>
                </div>
            </div>
