    ...
    return (
        <div className="p-4 sm:p-8">
            ...
            <div className="flex justify-between items-center mb-8">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900">Recurring Invoices</h1>
                <div className="flex items-center space-x-4">
                    <Link
                        to="/sales/recurringinvoices/new"
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg-2 border border-gray-100 min-h-[70vh]">
                ...
                <div className="overflow-x-auto whitespace-nowrap border-t border-gray-200">
                    ...
                    <div className="flex items-center border-b border-gray-200 py-3 text-sm font-semibold text-gray-700 min-w-[1000px]">
                        ...
                        <span className="w-[20%] px-2 cursor-pointer hover:text-blue-600">PROFILE NAME</span>
                        <span className="w-[20%] px-2">CUSTOMER NAME</span>
                        <span className="w-[15%] px-2">REPEAT EVERY</span>
                        <span className="w-[15%] px-2">NEXT INVOICE DATE</span>
                    ...
                    <div className="flex flex-col items-center justify-center h-full pt-20" style={{ minHeight: '40vh' }}>
                        ...
                        <p className="text-xl font-semibold text-gray-700 mb-2">No Recurring Invoices Found</p>
                        <p className="text-gray-500 text-center">
                            You haven't created any recurring invoices yet. Click 'New Recurring Invoice' to create one.
                        </p>
                    </div>
                </div>
            </div>
