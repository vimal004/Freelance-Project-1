        ...
        <div className="">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div className="flex items-center">
                    <h1 className="text-2xl font-bold text-gray-900 mr-2">New Delivery Challan</h1>
                </div>
                <Link to="/sales/deliverychallans" className="text-gray-500 hover:text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    {/* Delivery Challan# */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <label className="block text-sm font-medium text-red-500">Delivery Challan#*</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <label className="block text-sm font-medium text-red-500">Delivery Challan Date*</label>
                        <div className="md:col-span-2">
                            <input
                                type="date"
                    ...
                    {/* Challan Type */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        <label className="block text-sm font-medium text-red-500">Challan Type*</label>
                        <div className="md:col-span-2">
                            <select
                                name="challanType"
                ...
                {/* Attachments */}
                <div className="pt-4">
                    <label className="block text-sm font-medium text-gray-700 mb-2">Attach File(s) to Delivery Challan</label>
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition cursor-pointer">
                        ...
                        <span className="text-sm text-blue-600 font-medium">Upload File</span>
                        <span className="text-xs text-gray-500 mt-1">You can upload a maximum of 5 files, 10MB each</span>
                    </div>
                </div>
            </div>
